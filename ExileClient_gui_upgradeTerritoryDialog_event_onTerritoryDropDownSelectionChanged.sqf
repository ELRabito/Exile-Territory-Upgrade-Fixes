...
else
{
	...
	_costControl ctrlSetStructuredText(parseText format["<t size='1.4'>%1<img image='\exile_assets\texture\ui\poptab_inline_ca.paa' size='1' shadow='true' /></t>", (_territoryPrice call ExileClient_util_string_exponentToString]);
